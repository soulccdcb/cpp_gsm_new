...
ADD https://nodejs.org/dist/v13.14.0/node-v13.14.0-linux-x64.tar.gz /tmp/
RUN tar -xzf /tmp/node-v13.14.0-linux-x64.tar.gz -C /usr/local --strip-components=1 --no-same-owner && \
    rm -rf /tmp/*
