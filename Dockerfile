...
RUN set -x && apt-get update && apt-get install -y  openssh-server tzdata wget nginx ffmpeg iputils-ping  net-tools && rm -rf /var/lib/apt/lists/* /etc/apt/sources.list.d/*
